...
RATE_LIMIT_MINUTES = config("RATE_LIMIT_MINUTES", default=1, cast=int)
SOURCE_WALLET_PRIVATE_KEY = config("SOURCE_WALLET_PRIVATE_KEY")
ETH_AMOUNT = config("ETH_AMOUNT", default=0.0001, cast=float)
